...
- **ヒアリング**: 5-whys・具体シナリオ・MVP スコープ交渉で「本当に欲しいもの」を掘り当てる。推測ドラフトを提示して一括訂正を求める propose-and-confirm 方式で往復を最小化。コア課題が見えたら**アプリのコンセプトを2〜3案提案**（ミニマム／自動化寄り／別アングル）し、要求を超える機能改善も**提案**として提示。採否はユーザーが決める
